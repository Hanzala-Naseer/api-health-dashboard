...
const authRepository = {
  ...
  /**
 * Creates a new user.
 * User identity fields now live directly on the User document instead of
 * inside an embedded profile object.
 */
async createUserWithProfile({
 ...
 /**
 * Updates an abandoned/unverified signup in place.
 * Name fields now exist directly on the User document.
 */
updateResumedSignup(
  userId,
  {
