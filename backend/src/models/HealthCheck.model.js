...
/**
 * One row per monitoring probe.
 *
 * This collection can grow into millions of documents.
 * Indexes are query-driven because every index increases
 * write cost.
 *
 * responseHeaders uses Mixed because headers differ between
 * providers and are not queried directly.
 */
const healthCheckSchema = new mongoose.Schema(
